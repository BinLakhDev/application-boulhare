...
const Routes = ({ match }) => (
  <>
    <Switch>
      ...
      <ErrorBoundaryRoute exact path={`${match.url}/:id/edit`} component={AgenceUpdate} />
      <ErrorBoundaryRoute exact path={`${match.url}/:id`} component={AgenceDetail} />
      <ErrorBoundaryRoute path={match.url} component={Agence} />
    </Switch>
    <ErrorBoundaryRoute path={`${match.url}/:id/delete`} component={AgenceDeleteDialog} />
  </>
);
